$(document).ready(function () {
  ...
  for (x in dataShapes){
    ...
    if (currentShape.color!='red' && currentShape.color != 'blue'){
      currentShape.goodBehavior = 'spin'
    }
    dataShapes[x] = currentShape
  }
  ...
  function goodDisplay() {
    ...
    var current = dataShapes[currentIndex];
    handleGood(current.color, current.shape, current.repeat)
  }

  function badDisplay() {
    // TODO 5-b: call your handleBad function
    var current = dataShapes[currentIndex];
    handleBad(current, current.repeat)
  }
